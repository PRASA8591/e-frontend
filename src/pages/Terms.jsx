  ...
  const contentSI = useMemo(() => ({
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'මූල්‍ය වාර්තා ලුහුබැඳීම සඳහා PrasaTek System Solutions විසින් ඔබට පුද්ගලික බලපත්‍රයක් පිරිනමයි. අපගේ Backend පද්ධති පාලනයන් මඟහැරීමට උත්සාහ කිරීම හෝ දත්ත පිටපත් කිරීම සපයා නැත.',
        badge: 'බුද්ධිමය දේපළ'
      },
      {
        id: 'disclaimer',
        title: '5. වගකීම් සීමාව සහ වගකීම්',
        content: 'ExpenseTracker Pro සපයා ඇත්තේ "එලෙසින්ම" වේ. මෙම ගණනය කිරීම් නිල බදු වාර්තා ලෙස නියෝජනය නොවේ. මූල්‍ය සැලසුම් අසාර්ථකත්වයන් හෝ දත්ත මකා දැමීම් නිසා සිදුවන අලාභයන් සඳහා PrasaTek වගකියනු නොලැබේ.',
